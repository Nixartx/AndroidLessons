        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            String url_path = "https://stackoverflow.com/";
                            String content = getContent(url_path);
                            webView.post(new Runnable() {
                                @Override
                                public void run() {
                                    webView.loadDataWithBaseURL(url_path,content, "text/html", "UTF-8", url_path);
                            ...
                            contentView.post(new Runnable() {
                                public void run() {
                                    contentView.setText("Error: " + e.getMessage());
